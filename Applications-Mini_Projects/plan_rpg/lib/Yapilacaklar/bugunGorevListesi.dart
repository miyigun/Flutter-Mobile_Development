...
class bugunGorevListesi extends StatefulWidget {
  const bugunGorevListesi({Key? key}) : super(key: key);


  @override
  _bugunGorevListesiState createState() => _bugunGorevListesiState();
}

class _bugunGorevListesiState extends State<bugunGorevListesi>{
  ...
  void initState(){
    ...
    WidgetsBinding.instance!.addPostFrameCallback((_) async {
      ...
      if (_controller.cBugunkuGorevSayisi.value==0)
        Fluttertoast.showToast(
            msg: 'Bugün göreviniz bulunmamaktadır...',
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text('Bugün: '+DateFormat('dd/MM/yyyy').format(DateTime.parse(tarih)),style: TextStyle(fontWeight: FontWeight.bold, fontSize:20)),
          Obx(() =>Text(_controller.cBugunkuGorevSayisi.value.toString()+' görev var',
              style: TextStyle(
            fontSize: 14,
      ...
      body: Obx(() => AnimationLimiter(
        child: ListView.builder(
          ...
          itemCount: _controller.cBugunkuGorevSayisi.value,
          itemBuilder: (context, index) {
            //Her bir görev için tekrar 5 belirli sayıda ise o tespit ediliyor
            var ayristirilanMetin = [];
            String dosyaIcerik=_controller.bugunkuGorevler[index].tekrar;
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            else if (_controller.bugunkuGorevler[index].tekrar=='Her gün') Text("",style: TextStyle(fontWeight: FontWeight.bold))
                                            else if (_controller.bugunkuGorevler[index].tekrar=='Her hafta') Text("H",style: TextStyle(fontWeight: FontWeight.bold))
                                              else if (_controller.bugunkuGorevler[index].tekrar=='Her ay') Text("A",style: TextStyle(fontWeight: FontWeight.bold))
                                                else if (_controller.bugunkuGorevler[index].tekrar=='Her yıl') Text("Y",style: TextStyle(fontWeight: FontWeight.bold))
                                            ...
                                            else if (_controller.bugunkuGorevler[index].tekrar=='Her gün') Icon(Icons.all_inclusive_outlined)
                                              else if (_controller.bugunkuGorevler[index].tekrar=='Her hafta') Icon(Icons.refresh_outlined)
                                                else if (_controller.bugunkuGorevler[index].tekrar=='Her ay') Icon(Icons.refresh_outlined)
                                                  else if (_controller.bugunkuGorevler[index].tekrar=='Her yıl') Icon(Icons.refresh_outlined)
                                                    else Icon(Icons.refresh_outlined),
                                                    //else Icon(Icons.all_inclusive_outlined),
                                          ],
                                        ),

                                        if (_controller.bugunkuGorevler[index].onem==1) CircleAvatar(backgroundColor: Colors.red,radius: 5.0,)
                                        else if (_controller.bugunkuGorevler[index].onem==2) CircleAvatar(backgroundColor: Colors.blue,radius: 5.0,)
                                        else if (_controller.bugunkuGorevler[index].onem==3) CircleAvatar(backgroundColor: Colors.green,radius: 5.0,)
                                        else if (_controller.bugunkuGorevler[index].onem==4) CircleAvatar(backgroundColor: Colors.brown,radius: 5.0,),
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          width: _w/1.50,
                                          child: Text(_controller.bugunkuGorevler[index].ad,style: TextStyle(color: Colors.black, fontSize:14, fontWeight: FontWeight.bold)),
                                        ),
                                        //Text('',style: TextStyle(color: Colors.black, fontSize:12)),
                                        if (_controller.bugunkuGorevler[index].aciklama!='')
                                          Text(_controller.bugunkuGorevler[index].aciklama,style: TextStyle(color: Colors.black.withOpacity(.6), fontSize:12)),

                                        //witOpacity deki değer(.4) .0 a yaklaştıkça görünmez oluyor. 1 de oldukça koyu gösteriyor
                                        Text('Bugün',style: TextStyle(color: Colors.black.withOpacity(.4), fontSize:12)),
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text("TP: "+_controller.bugunkuGorevler[index].TP.toString(),style: TextStyle(color: Colors.black,fontSize:12)),
                                          Row(
                                              children: [
                                                Container(
                                                    width:_w/20,
                                                ...
                                                Text("  "+_controller.bugunkuGorevler[index].altin.toString(),style: TextStyle(color: Colors.black,fontSize:12)),
                                              ]
                                          ),
                                        ],
                                      ),
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(_controller.bugunkuGorevler[index].beceri,style: TextStyle(color: Colors.black,fontSize:12)),
                                          Text("TP:  "+_controller.bugunkuGorevler[index].beceriTP.toString(),style: TextStyle(color: Colors.black,fontSize:12)),
                                        ],
                                      ),
                                    ),
                                  ],
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            Alert(
                                ...
                                type: AlertType.none,
                                style: alertStyle,
                                title: 'Görev başarılı!\n'+_controller.bugunkuGorevler[index].ad+"\n",
                                desc: "Ödül:\n"
                                    "+" + _controller.bugunkuGorevler[index].TP.toString()+" TP\n"+
                                    "+" + _controller.bugunkuGorevler[index].altin.toString()+" Altın\n\n"+
                                    "İlişkili Beceri:\n"+"+" +_controller.bugunkuGorevler[index].beceriTP.toString()+' '+_controller.bugunkuGorevler[index].beceri+"\n\n"+
                                    "Tekrar:\n"+_controller.bugunkuGorevler[index].tekrar,
                                buttons: [
                                  DialogButton(
                                    child: Text(
                                      "TAMAM",
                                    ...
                                    onPressed: () {
                                      ...
                                      WidgetsBinding.instance!.addPostFrameCallback((_) async {
                                        ...
                                        int TP = _controller.bugunkuGorevler[index].TP;
                                        karakter.TP += TP;
                                        _controller.karakterTP.value=karakter.TP;
                                        int altin = _controller.bugunkuGorevler[index].altin;
                                        ...
                                        try{
                                          ...
                                          var gorev = Gorevler(
                                            no: _controller.bugunkuGorevler[index].no,
                                            ad: _controller.bugunkuGorevler[index].ad,
                                            aciklama:_controller.bugunkuGorevler[index].aciklama,
                                            tarih: _controller.bugunkuGorevler[index].tarih,
                                            tekrar: _controller.bugunkuGorevler[index].tekrar,
                                            yapildi: "Evet",
                                            basariDurumu: "Başarılı",
                                            altin: _controller.bugunkuGorevler[index].altin,
                                            TP: _controller.bugunkuGorevler[index].TP,
                                            beceriTP: _controller.bugunkuGorevler[index].beceriTP,
                                            beceri: _controller.bugunkuGorevler[index].beceri,
                                            onem: _controller.bugunkuGorevler[index].onem,
                                          );
                                          ...
                                          if (_controller.bugunkuGorevler[index].tekrar=="Her gün"){
                                            var gorev = Gorevler(
                                              no: enBuyukKayitNo+1,
                                              ad: _controller.bugunkuGorevler[index].ad,
                                              aciklama:_controller.bugunkuGorevler[index].aciklama,
                                              ...
                                              yapildi: "Hayır",
                                              basariDurumu: '',
                                              altin: _controller.bugunkuGorevler[index]
                                                  .altin,
                                              TP: _controller.bugunkuGorevler[index].TP,
                                              beceriTP: _controller.bugunkuGorevler[index].beceriTP,
                                              beceri: _controller.bugunkuGorevler[index]
                                                  .beceri,
                                              onem: _controller.bugunkuGorevler[index]
                                                  .onem,);
                                            await dosya.gorevEkle(gorev);
                                          }
                                          //Eğer görevin tekrar durumu "Her hafta" ise gelecek hafta için de aynı görev kaydediliyor
                                          else if (_controller.bugunkuGorevler[index].tekrar=="Her hafta"){
                                            var gorev = Gorevler(
                                                no: enBuyukKayitNo+1,
                                                ad: _controller.bugunkuGorevler[index].ad,
                                                aciklama:_controller.bugunkuGorevler[index].aciklama,
                                                tarih: birHaftaSonraTarih,
                                                tekrar: _controller.bugunkuGorevler[index].tekrar,
                                                yapildi: "Hayır",
                                                basariDurumu: '',
                                                altin: _controller.bugunkuGorevler[index]
                                          ...
                                          else if (_controller.bugunkuGorevler[index].tekrar=="Her ay"){
                                            var gorev = Gorevler(
                                                no: enBuyukKayitNo+1,
                                                ad: _controller.bugunkuGorevler[index].ad,
                                                aciklama:_controller.bugunkuGorevler[index].aciklama,
                                                tarih: birAySonraTarih,
                                                tekrar: _controller.bugunkuGorevler[index].tekrar,
                                                yapildi: "Hayır",
                                                basariDurumu: '',
                                                altin: _controller.bugunkuGorevler[index]
                                          ...
                                          //Eğer görevin tekrar durumu "Her yıl" ise gelecek hafta için de aynı görev kaydediliyor
                                          else if (_controller.bugunkuGorevler[index].tekrar=="Her yıl"){
                                            var gorev = Gorevler(
                                                no: enBuyukKayitNo+1,
                                                ad: _controller.bugunkuGorevler[index].ad,
                                                aciklama:_controller.bugunkuGorevler[index].aciklama,
                                                tarih: birYilSonraTarih,
                                                tekrar: _controller.bugunkuGorevler[index].tekrar,
                                                yapildi: "Hayır",
                                                basariDurumu: '',
                                                altin: _controller.bugunkuGorevler[index]
                                            ...
                                            if (deger!=0){
                                              //Veri tabanındaki görev numaraları belirleniyor
                                              var gorevNumaralari=[];
                                              int enBuyukKayitNo=karakter.bugunkuGorevSayisi;
                                              await dosya.gorevListeOlustur().then((List bugunkuGorevler) async {
                                                setState(() {
                                                  karakter.bugunkuGorevSayisi = bugunkuGorevler.length;
                                                  //Veritabanında yapılan kayıtların numaraları yazılma-silinmeden dolayı değişiyor.İlkönce onları tespit ediyoruz.
                                                  for (int i = 0; i < karakter.bugunkuGorevSayisi; i++) {
                                                    gorevNumaralari.add(bugunkuGorevler[i].no);
                                                  }
                                                  //En büyük kayıt numarası tespit ediliyor
                                                  for (int i = 0; i < karakter.bugunkuGorevSayisi; i++)
                                            ...
                                            DateTime t=DateTime.parse(_controller.bugunkuGorevler[index].tarih);
                                            ...
                                            for(int sayac=1;belirliGun+sayac<=7;sayac++)
                                              for(int i=0;i<gunler.length;i++){
                                                if(belirliGun+sayac==gunler[i]) {
                                                  ...
                                                  String ta=_controller.bugunkuGorevler[index].tarih;
                                            ...
                                            //print(DateFormat('dd/MM/yyyy').format(t));
                                          }
                                        } catch (e) {
                                        ...
                                        WidgetsBinding.instance!.addPostFrameCallback((_) async {
                                          if (karakter.bugunkuGorevSayisi==0)
                                      ...
                                      WidgetsBinding.instance!.addPostFrameCallback((_) async {
                                        ...
                                        try{
                                          ...
                                          var gorev = Gorevler(
                                              ...
                                              ad: _controller.bugunkuGorevler[index].ad,
                                              aciklama:_controller.bugunkuGorevler[index].aciklama,
                                              tarih: _controller.bugunkuGorevler[index]
                                                  .tarih,
                                              tekrar: _controller.bugunkuGorevler[index].tekrar,
                                              yapildi: "Evet",
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            String _tekrarIlk=_controller.bugunkuGorevler[index].tekrar;
                            ...
                            int onemB=_controller.bugunkuGorevler[index].onem;
                            ...
                            _popupselection5=_controller.bugunkuGorevler[index].beceri;
                            ...
                            setState(() {
                              gorevAdiControl.text=_controller.bugunkuGorevler[index].ad;
                              _controller.yeniGorevAdi.value=_controller.bugunkuGorevler[index].ad;
                              gorevAciklamaControl.text=_controller.bugunkuGorevler[index].aciklama;
                              _controller.yeniGorevAciklama.value=_controller.bugunkuGorevler[index].aciklama;
                              _controller.yeniGorevOnem.value=_controller.bugunkuGorevler[index].onem;
                              _controller.yeniGorevTarih.value=_controller.bugunkuGorevler[index].tarih;
                              _controller.yeniGorevTP.value=_controller.bugunkuGorevler[index].TP;
                              _controller.yeniGorevAltin.value=_controller.bugunkuGorevler[index].altin;
                              _controller.yeniGorevTekrar.value=_controller.bugunkuGorevler[index].tekrar;
                              _controller.yeniGorevIliskiliBeceri.value=_controller.bugunkuGorevler[index].beceri;
                              _controller.yeniGorevBeceriTP.value=_controller.bugunkuGorevler[index].beceriTP;
                              int beceriTP=_controller.bugunkuGorevler[index].beceriTP;
                            });
                            Alert(
                              context: context,
                                                              ...
                                                              children:[
                                                                ...
                                                                ButtonBar(
                                                                  children: <Widget>[
                                                                    SizedBox(
                                                                      width: _w/16.44,
                                                                      //_controller.yeniGorevGunuTekrarSayisi.value.toString(), yazdığımda hata verdi. int in val su olmazmış
                                                                    ...
                                                                    IconButton(
                                                                      ...
                                                                      onPressed: () {
                                                                        setState(() {
                                                                          ...
                                                                          // });
                                                                          // _controller.yeniGorevTekrar.value=_controller.yeniGorevGunuTekrarSayisi.value.toString()+" kez";
                                                                          //control3.text = "$gorevGunuTekrarSayisi";
                                                                        });
                                                                      } ,
                                                                    ),
                                                                    IconButton(
                                ...
                                DialogButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    var gorev = Gorevler(
                                        ...
                                        yapildi: _controller.bugunkuGorevler[index].yapildi,
                                        basariDurumu: _controller.bugunkuGorevler[index].basariDurumu,
                            ...
                            Alert(
                              ...
                              buttons: [
                                DialogButton(
                                  ...
                                  onPressed: () async {
                                    WidgetsBinding.instance!.addPostFrameCallback((_) async {
                                      await dosya.gorevSil(_controller.bugunkuGorevler[index].no);
