...
class tumGorevListesi extends StatefulWidget {
  const tumGorevListesi({Key? key}) : super(key: key);

  @override
  _tumGorevListesiState createState() => _tumGorevListesiState();
}

class _tumGorevListesiState extends State<tumGorevListesi>{
  ...
  void initState(){
    ...
    WidgetsBinding.instance!.addPostFrameCallback((_) async {
      if (_controller.tumGorevSayisi.value==0)
        Fluttertoast.showToast(
            msg: 'Hiç göreviniz bulunmamaktadır...',
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            ...
            Obx(() =>Text(_controller.tumGorevSayisi.value.toString()+' görev var',
                style: TextStyle(
                  fontSize: 14,
                  fontWeight: FontWeight.bold,
                ))),
      ...
      body: Obx(() => AnimationLimiter(
        child: ListView.builder(
          ...
          itemCount: _controller.tumGorevSayisi.value,
          itemBuilder: (context, index) {
            var ayristirilanMetin = [];
            String dosyaIcerik=_controller.tumGorevler[index].tekrar;
                                        ...
                                        children: [
                                          Column(children:[
                                            Row(children: [
                                              ...
                                              else if (_controller.tumGorevler[index].tekrar=='Her gün') Text("",style: TextStyle(fontWeight: FontWeight.bold))
                                              else if (_controller.tumGorevler[index].tekrar=='Her hafta') Text("H",style: TextStyle(fontWeight: FontWeight.bold))
                                                else if (_controller.tumGorevler[index].tekrar=='Her ay') Text("A",style: TextStyle(fontWeight: FontWeight.bold))
                                                  else if (_controller.tumGorevler[index].tekrar=='Her yıl') Text("Y",style: TextStyle(fontWeight: FontWeight.bold))
                                              ...
                                              else if (_controller.tumGorevler[index].tekrar=='Her gün') Icon(Icons.all_inclusive_outlined)
                                                else if (_controller.tumGorevler[index].tekrar=='Her hafta') Icon(Icons.refresh_outlined)
                                                  else if (_controller.tumGorevler[index].tekrar=='Her ay') Icon(Icons.refresh_outlined)
                                                    else if (_controller.tumGorevler[index].tekrar=='Her yıl') Icon(Icons.refresh_outlined)
                                                      else Icon(Icons.refresh_outlined),
                                            ]),

                                            if (_controller.tumGorevler[index].onem==1) CircleAvatar(backgroundColor: Colors.red,radius: 5.0,)
                                            else if (_controller.tumGorevler[index].onem==2) CircleAvatar(backgroundColor: Colors.blue,radius: 5.0,)
                                            else if (_controller.tumGorevler[index].onem==3) CircleAvatar(backgroundColor: Colors.green,radius: 5.0,)
                                            else if (_controller.tumGorevler[index].onem==4) CircleAvatar(backgroundColor: Colors.brown,radius: 5.0,),
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              Container(
                                                width: _w/1.50,
                                                child: Text(_controller.tumGorevler[index].ad,style: TextStyle(color: Colors.black, fontSize:14, fontWeight: FontWeight.bold)),
                                              ),
                                              //Text('',style: TextStyle(color: Colors.black, fontSize:12)),
                                              if (_controller.tumGorevler[index].aciklama!='')
                                                Text(_controller.tumGorevler[index].aciklama,style: TextStyle(color: Colors.black.withOpacity(.6), fontSize:12)),

                                              //Formatı değiştirerek ekrana yansıtıyoruz . Bu satırı yazmak yarım günüme mal oldu
                                              Text(DateFormat('dd/MM/yyyy').format(DateTime.parse(_controller.tumGorevler[index].tarih)),style: TextStyle(color: Colors.black.withOpacity(.4), fontSize:12)),
                                          ...
                                          Container(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text("TP: "+_controller.tumGorevler[index].TP.toString(),style: TextStyle(color: Colors.black,fontSize:12)),
                                                Row(
                                                    children: [
                                                      Container(
                                                          width:_w/20,
                                                      ...
                                                      Text("  "+_controller.tumGorevler[index].altin.toString(),style: TextStyle(color: Colors.black,fontSize:12)),
                                                    ]
                                                ),
                                              ],
                                            ),
                                          ...
                                          Container(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(_controller.tumGorevler[index].beceri,style: TextStyle(color: Colors.black,fontSize:12)),
                                                Text("TP:  "+_controller.tumGorevler[index].beceriTP.toString(),style: TextStyle(color: Colors.black,fontSize:12)),
                                              ],
                                            ),
                                          ),
                                        ],
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () {
                                  Alert(
                                      ...
                                      type: AlertType.none,
                                      style: alertStyle,
                                      title: 'Görev başarılı!\n'+_controller.tumGorevler[index].ad+"\n",
                                      desc: "Ödül:\n"
                                          "+" + _controller.tumGorevler[index].TP.toString()+" TP\n"+
                                          "+" + _controller.tumGorevler[index].altin.toString()+" Altın\n\n"+
                                          "İlişkili Beceri:\n"+"+" +_controller.tumGorevler[index].beceriTP.toString()+' '+_controller.tumGorevler[index].beceri+"\n\n"+
                                          "Tekrar:\n"+_controller.tumGorevler[index].tekrar,
                                      buttons: [
                                        DialogButton(
                                          child: Text(
                                            "TAMAM",
                                          ...
                                          onPressed: () {
                                            ...
                                            WidgetsBinding.instance!.addPostFrameCallback((_) async {
                                              setState(() {
                                                ...
                                                int TP = _controller.tumGorevler[index].TP;
                                                karakter.TP += TP;
                                                _controller.karakterTP.value=karakter.TP;
                                                int altin = _controller.tumGorevler[index].altin;
                                              ...
                                              String beceri = _controller.tumGorevler[index].beceri;
                                              int beceriTP = _controller.tumGorevler[index].beceriTP;
                                              ...
                                              try{
                                                ...
                                                var gorev = Gorevler(
                                                    no: _controller.tumGorevler[index].no,
                                                    ad: _controller.tumGorevler[index].ad,
                                                    aciklama: _controller.tumGorevler[index].aciklama,
                                                    tarih: _controller.tumGorevler[index]
                                                        .tarih,
                                                    tekrar: _controller.tumGorevler[index].tekrar,
                                                    yapildi: "Evet",
                                                    basariDurumu: 'Başarılı',
                                                    altin: _controller.tumGorevler[index]
                                                        .altin,
                                                    TP: _controller.tumGorevler[index].TP,
                                                    beceriTP: _controller.tumGorevler[index].beceriTP,
                                                    beceri: _controller.tumGorevler[index]
                                                        .beceri,
                                              ...
                                              try{
                                                ...
                                                else if (_controller.tumGorevler[index].tekrar=="Her hafta"){
                                                  //Veritabanına DateTime formatında kaydediyoruz
                                                  //Bu sayede tarihe ekleme-çıkarmayı rahatlıkla yapabiliyoruz
                                                  String t=_controller.tumGorevler[index].tarih;
                                                ...
                                                else if (_controller.tumGorevler[index].tekrar=="Her ay"){
                                                  //Veritabanına DateTime formatında kaydediyoruz
                                                  //Bu sayede tarihe ekleme-çıkarmayı rahatlıkla yapabiliyoruz
                                                  String t=_controller.tumGorevler[index].tarih;
                                                ...
                                                //Eğer görevin tekrar durumu "Her yıl" ise gelecek hafta için de aynı görev kaydediliyor
                                                else if (_controller.tumGorevler[index].tekrar=="Her yıl"){
                                                  //Veritabanına DateTime formatında kaydediyoruz
                                                  //Bu sayede tarihe ekleme-çıkarmayı rahatlıkla yapabiliyoruz
                                                  String t=_controller.tumGorevler[index].tarih;
                                                  ...
                                                  if (deger!=0){
                                                    ...
                                                    var gorev = Gorevler(
                                                      ...
                                                      yapildi: "Hayır",
                                                      basariDurumu: '',
                                                      altin: _controller.tumGorevler[index].altin,
                                                      TP: _controller.tumGorevler[index].TP,
                                                      beceriTP: _controller.tumGorevler[index].beceriTP,
                                                      beceri: _controller.tumGorevler[index].beceri,
                                                      onem: _controller.tumGorevler[index].onem,);
                                                    await dosya.gorevEkle(gorev);
                                                  }
                                                }
                                                  ...
                                                  DateTime t=DateTime.parse(_controller.tumGorevler[index].tarih);
                                                  ...
                                                  for(int sayac=1;belirliGun+sayac<=7;sayac++)
                                                    for(int i=0;i<gunler.length;i++){
                                                      if(belirliGun+sayac==gunler[i]) {
                                                        ...
                                                        String ta=_controller.tumGorevler[index].tarih;
                              ...
                              IconButton(
                                ...
                                onPressed: () {
                                  var ilkDeger=_controller.tumGorevler[index].tarih;
                                  String _tekrarIlk=_controller.tumGorevler[index].tekrar;
                                  ...
                                  int onemB=_controller.tumGorevler[index].onem;
                                  ...
                                  if (ayristirilanMetin[1]=='kez' || ayristirilanMetin[1]=='gün' || ayristirilanMetin[1]=='hafta' || ayristirilanMetin[1]=='yıl')
                                    _popupselection4=_controller.tumGorevler[index].tekrar;
                                  else {
                                    String gunler='';
                                  ...
                                  _popupselection5=_controller.tumGorevler[index].beceri;
                                  ...
                                  setState(() {
                                    gorevAdiControl.text=_controller.tumGorevler[index].ad;
                                    _controller.yeniGorevAdi.value=_controller.tumGorevler[index].ad;
                                    gorevAciklamaControl.text=_controller.tumGorevler[index].aciklama;
                                    _controller.yeniGorevAciklama.value=_controller.tumGorevler[index].aciklama;
                                    _controller.yeniGorevOnem.value=_controller.tumGorevler[index].onem;
                                    _controller.yeniGorevTarih.value=_controller.tumGorevler[index].tarih;
                                    _controller.yeniGorevTP.value=_controller.tumGorevler[index].TP;
                                    _controller.yeniGorevAltin.value=_controller.tumGorevler[index].altin;
                                    _controller.yeniGorevTekrar.value=_controller.tumGorevler[index].tekrar;
                                    _controller.yeniGorevIliskiliBeceri.value=_controller.tumGorevler[index].beceri;
                                    _controller.yeniGorevBeceriTP.value=_controller.tumGorevler[index].beceriTP;
                                  });
                                  Alert(
                                    context: context,
                                    type: AlertType.none,
                                                        ...
                                                        PopupMenuButton<String>(
                                                          onSelected: (String value) async {
                                                            setState(()  {
                                                              ...
                                                              var ilkDeger=_controller.yeniGorevTarih.value;
                                                            });
                                                            //bugün veya yarın tarih seçilirse yeniGorev.tarih e aktar
                                                            //fakat 'Başka bir tarih' seçilirse atama işlemini sonraya bırak
                                                            if (_popupselection4.toString()=="1 kez") {
                                                              ...
                                                              if (values!=null) {
                                                                setState(() {
                                                                  ...
                                                                  DateTime t=DateTime.parse(_controller.yeniGorevTarih.value.toString());
                                                                  int kacinciGun=t.weekday;
                                                                  ...
                                                                  for(int i in values){
                                                                    if(kacinciGun==i) {
                                                                      ...
                                                                      _controller.yeniGorevTarih.value=ilkDeger;
                                                                      break;
                                                                    }
                                                                  }
                                                                  ...
                                                                  if (gunlerdenBiriMi==false) {
                                                                    for(int i in values){
                                                                      if(i>kacinciGun){
                                                                        ...
                                                                        DateTime ta=DateTime.parse((t.add(Duration(days: gunFarki))).toString());
                                                                        String dtTarih =DateFormat('yyyy-MM-dd').format(ta);
                                      ...
                                      DialogButton(
                                        ...
                                        onPressed: () async {
                                          ...
                                          var gorev = Gorevler(
                                              ...
                                              yapildi: _controller.tumGorevler[index].yapildi,
                                              basariDurumu: _controller.tumGorevler[index].basariDurumu,
                                  ...
                                  Alert(
                                    ...
                                    buttons: [
                                      DialogButton(
                                        ...
                                        onPressed: () async {
                                          WidgetsBinding.instance!.addPostFrameCallback((_) async {
                                            await dosya.gorevSil(_controller.tumGorevler[index].no);
