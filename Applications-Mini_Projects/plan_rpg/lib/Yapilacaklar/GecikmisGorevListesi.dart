...
class gecikmisGorevListesi extends StatefulWidget {
  const gecikmisGorevListesi({Key? key}) : super(key: key);


  @override
  _gecikmisGorevListesiState createState() => _gecikmisGorevListesiState();
}

class _gecikmisGorevListesiState extends State<gecikmisGorevListesi>{
  ...
  void initState(){
    ...
    WidgetsBinding.instance!.addPostFrameCallback((_) async {
      //   Center(child: Text("Bugün göreviniz bulunmamaktadır...",style: TextStyle(color: Colors.white)));

      if (_controller.gecikmisGorevSayisi.value==0)
        Fluttertoast.showToast(
            msg: 'Gecikmiş göreviniz bulunmamaktadır...',
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text('Gecikmiş görevler',
                style: TextStyle(
                  fontSize: 20,
                  fontWeight: FontWeight.bold,
                )),
            Obx(() =>Text(_controller.gecikmisGorevSayisi.value.toString()+' gecikmiş görev var',
                style: TextStyle(
                  fontSize: 14,
                  fontWeight: FontWeight.bold,
                ))),
        ...
        actions: <Widget>[
          ...
          IconButton(
            ...
            onPressed: () {
              ...
              //Get.to(YeniGorevEkle(dosyaIslemleri: DosyaIslemleri()));
            },
          ),
        ],
      ),
      body: Obx(() => AnimationLimiter(
        child: ListView.builder(
          ...
          itemCount: _controller.gecikmisGorevSayisi.value,
          itemBuilder: (context, index) {
            //Her bir görev için tekrar 5 belirli sayıda ise o tespit ediliyor
            var ayristirilanMetin = [];
            String dosyaIcerik=_controller.gecikmisGorevler[index].tekrar;
                      ...
                      child: Row(
                        children: [
                                              ...
                                              children: [
                                                Row(
                                                  children: [
                                                    ...
                                                    else if (_controller.gecikmisGorevler[index].tekrar=='Her gün') Text("",style: TextStyle(fontWeight: FontWeight.bold))
                                                      else if (_controller.gecikmisGorevler[index].tekrar=='Her hafta') Text("H",style: TextStyle(fontWeight: FontWeight.bold))
                                                        else if (_controller.gecikmisGorevler[index].tekrar=='Her ay') Text("A",style: TextStyle(fontWeight: FontWeight.bold))
                                                          else if (_controller.gecikmisGorevler[index].tekrar=='Her yıl') Text("Y",style: TextStyle(fontWeight: FontWeight.bold))
                                                    ...
                                                    else if (_controller.gecikmisGorevler[index].tekrar=='Her gün') Icon(Icons.all_inclusive_outlined)
                                                      else if (_controller.gecikmisGorevler[index].tekrar=='Her hafta') Icon(Icons.refresh_outlined)
                                                        else if (_controller.gecikmisGorevler[index].tekrar=='Her ay') Icon(Icons.refresh_outlined)
                                                          else if (_controller.gecikmisGorevler[index].tekrar=='Her yıl') Icon(Icons.refresh_outlined)
                                                            else Icon(Icons.refresh_outlined),
                                                    //else Icon(Icons.all_inclusive_outlined),
                                                  ],
                                                ),

                                                if (_controller.gecikmisGorevler[index].onem==1) CircleAvatar(backgroundColor: Colors.red,radius: 5.0,)
                                                else if (_controller.gecikmisGorevler[index].onem==2) CircleAvatar(backgroundColor: Colors.blue,radius: 5.0,)
                                                else if (_controller.gecikmisGorevler[index].onem==3) CircleAvatar(backgroundColor: Colors.green,radius: 5.0,)
                                                  else if (_controller.gecikmisGorevler[index].onem==4) CircleAvatar(backgroundColor: Colors.brown,radius: 5.0,),
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                Container(
                                                  ...
                                                  width: _w/1.50,
                                                  child: Text(_controller.gecikmisGorevler[index].ad,style: TextStyle(color: Colors.black, fontSize:14, fontWeight: FontWeight.bold)),
                                                ),
                                                //Text('',style: TextStyle(color: Colors.black, fontSize:12)),
                                                if (_controller.gecikmisGorevler[index].aciklama!='')
                                                  Text(_controller.gecikmisGorevler[index].aciklama,style: TextStyle(color: Colors.black.withOpacity(.6), fontSize:12)),

                                                //Formatı değiştirerek ekrana yansıtıyoruz . Bu satırı yazmak yarım günüme mal oldu
                                                Text(DateFormat('dd/MM/yyyy').format(DateTime.parse(_controller.gecikmisGorevler[index].tarih)),style: TextStyle(color: Colors.black.withOpacity(.4), fontSize:12)),
                                                ...
                                                Text('',style: TextStyle(color: Colors.black, fontSize:12)),
                                                //Text('',style: TextStyle(color: Colors.black, fontSize:12)),
                                                //Text(_controller.bugunkuGorevler[index].tarih,style: TextStyle(color: Colors.black,fontSize:12)),
                                              ],
                                            ),
                                          ],
                                        ),
                                            ...
                                            Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text("TP: "+_controller.gecikmisGorevler[index].TP.toString(),style: TextStyle(color: Colors.black,fontSize:12)),
                                                  Row(
                                                      children: [
                                                        Container(
                                                            width:_w/20,
                                                        ...
                                                        Text("  "+_controller.gecikmisGorevler[index].altin.toString(),style: TextStyle(color: Colors.black,fontSize:12)),
                                                      ]
                                                  ),
                                                ],
                                              ),
                                            ...
                                            Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(_controller.gecikmisGorevler[index].beceri,style: TextStyle(color: Colors.black,fontSize:12)),
                                                  Text("TP:  "+_controller.gecikmisGorevler[index].beceriTP.toString(),style: TextStyle(color: Colors.black,fontSize:12)),
                                                ],
                                              ),
                                            ),
                                          ],
                          ...
                          Container(
                            ...
                            child: Column(
                              //İkonlar arasına eşit uzaklık koyar
                              ...
                              children: [
                                ...
                                IconButton(
                                  ...
                                  onPressed: () {
                                    Alert(
                                        ...
                                        type: AlertType.none,
                                        style: alertStyle,
                                        title: 'Görev başarılı!\n'+_controller.gecikmisGorevler[index].ad+"\n",
                                        desc: "Ödül:\n"
                                            "+" + _controller.gecikmisGorevler[index].TP.toString()+" TP\n"+
                                            "+" + _controller.gecikmisGorevler[index].altin.toString()+" Altın\n\n"+
                                            "İlişkili Beceri:\n"+"+" +_controller.gecikmisGorevler[index].beceriTP.toString()+' '+_controller.gecikmisGorevler[index].beceri+"\n\n"+
                                            "Tekrar:\n"+_controller.gecikmisGorevler[index].tekrar,
                                        buttons: [
                                          DialogButton(
                                            child: Text(
                                              "TAMAM",
                                            ...
                                            onPressed: () {
                                              ...
                                              WidgetsBinding.instance!.addPostFrameCallback((_) async {
                                                ...
                                                int TP = _controller.gecikmisGorevler[index].TP;
                                                karakter.TP += TP;
                                                _controller.karakterTP.value=karakter.TP;
                                                int altin = _controller.gecikmisGorevler[index].altin;
                                                ...
                                                String beceri = _controller.gecikmisGorevler[index].beceri;
                                                int beceriTP = _controller.gecikmisGorevler[index].beceriTP;
                                                ...
                                                try{
                                                  ...
                                                  var gorev = Gorevler(
                                                    no: _controller.gecikmisGorevler[index].no,
                                                    ad: _controller.gecikmisGorevler[index].ad,
                                                    aciklama:_controller.gecikmisGorevler[index].aciklama,
                                                    tarih: _controller.gecikmisGorevler[index].tarih,
                                                    tekrar: _controller.gecikmisGorevler[index].tekrar,
                                                    yapildi: "Evet",
                                                    basariDurumu: "Başarılı",
                                                    altin: _controller.gecikmisGorevler[index].altin,
                                                    TP: _controller.gecikmisGorevler[index].TP,
                                                    beceriTP: _controller.gecikmisGorevler[index].beceriTP,
                                                    beceri: _controller.gecikmisGorevler[index].beceri,
                                                    onem: _controller.gecikmisGorevler[index].onem,
                                                  );
                                                  ...
                                                  if (_controller.gecikmisGorevler[index].tekrar=="Her gün"){
                                                    ...
                                                    var gorev = Gorevler(
                                                      ...
                                                      yapildi: "Hayır",
                                                      basariDurumu: '',
                                                      altin: _controller.gecikmisGorevler[index]
                                                          .altin,
                                                      TP: _controller.gecikmisGorevler[index].TP,
                                                      beceriTP: _controller.gecikmisGorevler[index].beceriTP,
                                                      beceri: _controller.gecikmisGorevler[index]
                                                          .beceri,
                                                      onem: _controller.gecikmisGorevler[index]
                                                          .onem,);
                                                    await dosya.gorevEkle(gorev);
                                                  }
                                                  //Eğer görevin tekrar durumu "Her hafta" ise gelecek hafta için de aynı görev kaydediliyor
                                                  else if (_controller.gecikmisGorevler[index].tekrar=="Her hafta"){
                                                    //Veritabanına DateTime formatında kaydediyoruz
                                                    //Bu sayede tarihe ekleme-çıkarmayı rahatlıkla yapabiliyoruz
                                                    String t=_controller.gecikmisGorevler[index].tarih;
                                                  ...
                                                  else if (_controller.gecikmisGorevler[index].tekrar=="Her ay"){
                                                    //Veritabanına DateTime formatında kaydediyoruz
                                                    //Bu sayede tarihe ekleme-çıkarmayı rahatlıkla yapabiliyoruz
                                                    String t=_controller.gecikmisGorevler[index].tarih;
                                                  ...
                                                  //Eğer görevin tekrar durumu "Her yıl" ise gelecek hafta için de aynı görev kaydediliyor
                                                  else if (_controller.gecikmisGorevler[index].tekrar=="Her yıl"){
                                                    //Veritabanına DateTime formatında kaydediyoruz
                                                    //Bu sayede tarihe ekleme-çıkarmayı rahatlıkla yapabiliyoruz
                                                    String t=_controller.gecikmisGorevler[index].tarih;
                                                    ...
                                                    if (deger!=0){
                                                      //Veri tabanındaki görev numaraları belirleniyor
                                                      var gorevNumaralari=[];
                                                      int enBuyukKayitNo=karakter.gecikmisGorevSayisi;
                                                      await dosya.gorevGecikmisGorevListeOlustur().then((List gecikmisGorevler) async {
                                                        setState(() {
                                                          ...
                                                          //Veritabanında yapılan kayıtların numaraları yazılma-silinmeden dolayı değişiyor.İlkönce onları tespit ediyoruz.
                                                          for (int i = 0; i < karakter.gecikmisGorevSayisi; i++) {
                                                            gorevNumaralari.add(gecikmisGorevler[i].no);
                                                          }
                                                          //En büyük kayıt numarası tespit ediliyor
                                                          for (int i = 0; i < karakter.gecikmisGorevSayisi; i++)
                                                    ...
                                                    DateTime t=DateTime.parse(_controller.gecikmisGorevler[index].tarih);
                                                    ...
                                                    for(int sayac=1;belirliGun+sayac<=7;sayac++)
                                                      for(int i=0;i<gunler.length;i++){
                                                        if(belirliGun+sayac==gunler[i]) {
                                                          ...
                                                          String ta=_controller.gecikmisGorevler[index].tarih;
                                                ...
                                                WidgetsBinding.instance!.addPostFrameCallback((_) async {
                                                  if (karakter.gecikmisGorevSayisi==0)
                                                    Center(child: Text("Bugün göreviniz bulunmamaktadır..."));
                                                });
                                              ...
                                              WidgetsBinding.instance!.addPostFrameCallback((_) async {
                                                ...
                                                try{
                                                  ...
                                                  var gorev = Gorevler(
                                                      ...
                                                      ad: _controller.gecikmisGorevler[index].ad,
                                                      aciklama:_controller.gecikmisGorevler[index].aciklama,
                                                      tarih: _controller.gecikmisGorevler[index]
                                                          .tarih,
                                                      tekrar: _controller.gecikmisGorevler[index].tekrar,
                                                      yapildi: "Evet",
                                                  ...
                                                  await dosya.gorevGecikmisGorevListeOlustur().then((List gecikmisGorevler) async {
                                                    setState(() {
                                                      karakter.gecikmisGorevSayisi =
                                                          gecikmisGorevler.length;
                                                ...
                                                WidgetsBinding.instance!.addPostFrameCallback((_) async {
                                                  if (karakter.gecikmisGorevSayisi==0)
                                                    Center(child: Text("Gecikmiş göreviniz bulunmamaktadır..."));
                                                });
                                ...
                                IconButton(
                                  ...
                                  onPressed: () {
                                    String _tekrarIlk=_controller.gecikmisGorevler[index].tekrar;
                                    ...
                                    int onemB=_controller.gecikmisGorevler[index].onem;
                                    ...
                                    if (ayristirilanMetin[1]=='kez' || ayristirilanMetin[1]=='gün' || ayristirilanMetin[1]=='hafta' || ayristirilanMetin[1]=='yıl')
                                      _popupselection4=_controller.gecikmisGorevler[index].tekrar;
                                    else {
                                      String gunler='';
                                    ...
                                    _popupselection5=_controller.gecikmisGorevler[index].beceri;
                                    ...
                                    setState(() {
                                      gorevAdiControl.text=_controller.gecikmisGorevler[index].ad;
                                      _controller.yeniGorevAdi.value=_controller.gecikmisGorevler[index].ad;
                                      gorevAciklamaControl.text=_controller.gecikmisGorevler[index].aciklama;
                                      _controller.yeniGorevAciklama.value=_controller.gecikmisGorevler[index].aciklama;
                                      _controller.yeniGorevOnem.value=_controller.gecikmisGorevler[index].onem;
                                      _controller.yeniGorevTarih.value=_controller.gecikmisGorevler[index].tarih;
                                      _controller.yeniGorevTP.value=_controller.gecikmisGorevler[index].TP;
                                      _controller.yeniGorevAltin.value=_controller.gecikmisGorevler[index].altin;
                                      _controller.yeniGorevTekrar.value=_controller.gecikmisGorevler[index].tekrar;
                                      _controller.yeniGorevIliskiliBeceri.value=_controller.gecikmisGorevler[index].beceri;
                                      _controller.yeniGorevBeceriTP.value=_controller.gecikmisGorevler[index].beceriTP;
                                      int beceriTP=_controller.gecikmisGorevler[index].beceriTP;
                                    });
                                    Alert(
                                      context: context,
                                        ...
                                        DialogButton(
                                          ...
                                          onPressed: () async {
                                            ...
                                            var gorev = Gorevler(
                                                ...
                                                yapildi: _controller.gecikmisGorevler[index].yapildi,
                                                basariDurumu: _controller.gecikmisGorevler[index].basariDurumu,
                                            ...
                                            setState(() {
                                              //yeni görev için ekran temizleniyor
                                              _controller.yeniGorevAdi=''.obs;
                                              _controller.yeniGorevAciklama=''.obs;
                                              _controller.yeniGorevOnem=1.obs;
                                              _controller.yeniGorevTarih=tarih.obs;
                                              _controller.yeniGorevTP=0.obs;
                                              _controller.yeniGorevAltin=0.obs;
                                              _controller.yeniGorevTekrar='1 kez'.obs;
                                              _controller.yeniGorevIliskiliBeceri=''.obs;
                                              _controller.yeniGorevBeceriTP=0.obs;
                                            });
                                    ...
                                    Alert(
                                      ...
                                      buttons: [
                                        DialogButton(
                                          ...
                                          onPressed: () async {
                                            WidgetsBinding.instance!.addPostFrameCallback((_) async {
                                              await dosya.gorevSil(_controller.gecikmisGorevler[index].no);
